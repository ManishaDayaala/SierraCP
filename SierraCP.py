...
MAINFOLDER = r"./APPdata_SierraCP"

# Create other paths relative to the main folder
training_file_path = os.path.join(MAINFOLDER, "Training", "Training_SierraCP.xlsx")  # FIXED TRAINING DATA
test_file_path = os.path.join(MAINFOLDER, "24hrData", "Dailydata_SierraCP.xlsx")  # DAILY DATA
excel_file_path = os.path.join(MAINFOLDER, "Breakdownrecords_SierraCP.xlsx")  # Recording excel for BD
folderpath = os.path.join(MAINFOLDER, "TemporaryData")  # Temporary dump files collector
threshold_file_path = os.path.join(MAINFOLDER,"Thresholds_SierraCP.xlsx") 
...
title_font_size = 40    # Adjust title font size
...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        ...
        <span style="font-size: {title_font_size}px; font-weight: bold;">Breakdown Predictor-Sierra Burnishing(CP)</span>
    </div>
...
def process_all_files():
    ...
    assets_list = [
        "Coolant Pump MDE","Coolant Pump MNDE","Coolant Pump PDE",
        "Hydraulic Pump MNDE","Hydraulic Pump PDE","Sierra Burnishing  Machine MNDE", "Sierra Burnishing Machine MDE",
        "Sierra Burnishing Machine Spindle DE", "Sierra Burnishing Machine Spindle NDE"]
